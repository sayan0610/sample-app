...
// Ensure proto namespace exists for generated assignments
const proto = { tasks: {} };

import google_protobuf_wrappers_pb, { StringValue, BoolValue } from 'google-protobuf/google/protobuf/wrappers_pb.js';
...
goog.inherits(proto.tasks.Task, Message);
...
goog.inherits(proto.tasks.ListRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.tasks.ListResponse = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.tasks.ListResponse.repeatedFields_, null);
};
goog.inherits(proto.tasks.ListResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.GetRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.CreateRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.UpdateRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.PatchRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.DeleteRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.DeleteResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.tasks.BulkDeleteRequest = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.tasks.BulkDeleteRequest.repeatedFields_, null);
};
goog.inherits(proto.tasks.BulkDeleteRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.tasks.BulkDeleteResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
title: Message.getFieldWithDefault(msg, 2, ""),
details: Message.getFieldWithDefault(msg, 3, ""),
completed: Message.getBooleanFieldWithDefault(msg, 4, false),
completionreason: Message.getFieldWithDefault(msg, 5, ""),
completionsignature: Message.getFieldWithDefault(msg, 6, ""),
createdat: Message.getFieldWithDefault(msg, 7, ""),
updatedat: Message.getFieldWithDefault(msg, 8, ""),
completedat: Message.getFieldWithDefault(msg, 9, "")
  };
...
proto.tasks.Task.prototype.getCompleted = function() {
  return /** @type {boolean} */ (Message.getBooleanFieldWithDefault(this, 4, false));
};
...
proto.tasks.ListRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
filter: Message.getFieldWithDefault(msg, 1, ""),
page: Message.getFieldWithDefault(msg, 2, 0),
pagesize: Message.getFieldWithDefault(msg, 3, 0)
  };
...
proto.tasks.ListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
itemsList: Message.toObjectList(msg.getItemsList(),
...
proto.tasks.ListResponse.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.tasks.Task>} */ (
    Message.getRepeatedWrapperField(this, proto.tasks.Task, 1));
};
...
proto.tasks.ListResponse.prototype.addItems = function(opt_value, opt_index) {
  return Message.addToRepeatedWrapperField(this, 1, opt_value, proto.tasks.Task, opt_index);
};
...
proto.tasks.CreateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
title: Message.getFieldWithDefault(msg, 1, ""),
details: Message.getFieldWithDefault(msg, 2, "")
  };
...
proto.tasks.PatchRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
id: Message.getFieldWithDefault(msg, 1, 0),
title: (f = msg.getTitle()) && StringValue.toObject(includeInstance, f),
details: (f = msg.getDetails()) && StringValue.toObject(includeInstance, f),
completed: (f = msg.getCompleted()) && BoolValue.toObject(includeInstance, f),
completionreason: (f = msg.getCompletionreason()) && StringValue.toObject(includeInstance, f),
completionsignature: (f = msg.getCompletionsignature()) && StringValue.toObject(includeInstance, f)
  };
...
proto.tasks.PatchRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value,StringValue.deserializeBinaryFromReader);
      msg.setTitle(value);
      break;
    case 3:
      var value = new StringValue;
    ...
    case 4:
      ...
      reader.readMessage(value,BoolValue.deserializeBinaryFromReader);
      msg.setCompleted(value);
      break;
    case 5:
      var value = new StringValue;
...
proto.tasks.PatchRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      StringValue.serializeBinaryToWriter
    );
  }
  f = message.getDetails();
  if (f != null) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      BoolValue.serializeBinaryToWriter
    );
  }
  f = message.getCompletionreason();
  if (f != null) {
...
proto.tasks.PatchRequest.prototype.getTitle = function() {
  return /** @type{?proto.google.protobuf.StringValue} */ (
    Message.getWrapperField(this, StringValue, 2));
};
...
proto.tasks.PatchRequest.prototype.getDetails = function() {
  return /** @type{?proto.google.protobuf.StringValue} */ (
    Message.getWrapperField(this, StringValue, 3));
};
...
proto.tasks.PatchRequest.prototype.getCompleted = function() {
  return /** @type{?proto.google.protobuf.BoolValue} */ (
    Message.getWrapperField(this, BoolValue, 4));
};
...
proto.tasks.PatchRequest.prototype.getCompletionreason = function() {
  return /** @type{?proto.google.protobuf.StringValue} */ (
    Message.getWrapperField(this, StringValue, 5));
};
...
proto.tasks.PatchRequest.prototype.getCompletionsignature = function() {
  return /** @type{?proto.google.protobuf.StringValue} */ (
    Message.getWrapperField(this, StringValue, 6));
};
...
proto.tasks.DeleteResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
ok: Message.getBooleanFieldWithDefault(msg, 1, false)
  };
...
proto.tasks.BulkDeleteRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
idsList: (f = Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
...
proto.tasks.BulkDeleteResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
deleted: Message.getFieldWithDefault(msg, 1, 0)
  };
...
goog.object.extend(globalThis, proto.tasks);

export default proto.tasks;
