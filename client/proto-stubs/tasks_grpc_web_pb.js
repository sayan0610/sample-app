...
import tasks_pb from './tasks_pb.js';
...
// Explicitly assign all required message types to proto.tasks
proto.tasks.ListRequest = tasks_pb.ListRequest;
proto.tasks.ListResponse = tasks_pb.ListResponse;
proto.tasks.GetRequest = tasks_pb.GetRequest;
proto.tasks.Task = tasks_pb.Task;
proto.tasks.CreateRequest = tasks_pb.CreateRequest;
proto.tasks.UpdateRequest = tasks_pb.UpdateRequest;
proto.tasks.PatchRequest = tasks_pb.PatchRequest;
proto.tasks.DeleteRequest = tasks_pb.DeleteRequest;
proto.tasks.DeleteResponse = tasks_pb.DeleteResponse;
proto.tasks.BulkDeleteRequest = tasks_pb.BulkDeleteRequest;
proto.tasks.BulkDeleteResponse = tasks_pb.BulkDeleteResponse;

// Assign any other exports from tasks_pb
Object.assign(proto.tasks, tasks_pb);
...
proto.tasks.TasksClient = TasksClient;
...
proto.tasks.TasksPromiseClient = TasksPromiseClient;
...
const methodDescriptor_Tasks_List = new grpc.web.MethodDescriptor(
  ...
  tasks_pb.ListRequest,
  tasks_pb.ListResponse,
  /**
  ...
  tasks_pb.ListResponse.deserializeBinary
);
